...
$('body').on('click', function () {
    ...
    if ($("#limobile").hasClass('divopen') && a == 1) {
        $("#limobile").removeClass("divopen");
    }
    a = 1;
    if ($("#limobile1").hasClass('divopen') && b == 1) {
        $("#limobile1").removeClass("divopen");
    }
    b = 1;
...
jQuery("#imgmobile").click(function () {
    a = 0;
    $("#limobile").addClass("divopen");
});
jQuery("#imgmobile1").click(function () {
    $("#limobile1").addClass("divopen");
    b = 0;
});
